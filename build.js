...
const SRC_PREFLOP_CORE = path.join(SRC, 'preflop_core.js');
const SRC_PREFLOP_CONTEXT_HELPERS = path.join(SRC, 'preflop_context_helpers.js');
...
const PREFLOP_CORE_TOKEN = '// FISH_TANK_PREFLOP_CORE_MODULE';
const PREFLOP_CONTEXT_HELPERS_TOKEN = '  // FISH_TANK_PREFLOP_CONTEXT_HELPERS_MODULE';
...
function buildHtml() {
  ...
  app = inlineModule(app, PREFLOP_EVALUATION_TOKEN, SRC_PREFLOP_EVALUATION);
